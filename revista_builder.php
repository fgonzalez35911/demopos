...
<body>
<div class="no-print" style="background: #102A57; height: 56px; padding: 0 20px; display: flex; align-items: center; justify-content: space-between; color: white; border-bottom: 2px solid #ffc400;">
    <span style="font-weight: bold; font-family: 'Roboto Condensed', sans-serif; font-size: 1.2rem; letter-spacing: 1px;">
        <i class="bi bi-magic text-warning me-2"></i> CONSTRUCTOR DE OFERTAS
    </span>
    <a href="dashboard.php" class="btn btn-sm btn-light fw-bold text-dark" style="border-radius: 4px; text-decoration: none;">
