...
<div class="container-fluid mt-n4 pb-5 px-2 px-md-4" style="position: relative; z-index: 20;">
    ...
    <div class="minimal-toolbar">
        <form id="formFiltrosSorteos" method="GET" class="d-flex w-100 align-items-center gap-2 m-0">
            <div class="search-input-group">
                <i class="bi bi-search"></i>
                <input type="text" name="buscar" placeholder="Buscar nombre de sorteo..." value="<?php echo htmlspecialchars($buscar); ?>" autocomplete="off">
            </div>
            ...
            <button type="button" class="btn btn-light border btn-filter-trigger shadow-sm" onclick="abrirFiltrosSorteos()">
        ...
        Swal.fire({
            ...
            html: `
                <div style="text-align: left; display: flex; flex-direction: column; gap: 15px; margin-top: 10px;">
                    ...
                    <div><label class="small fw-bold text-muted text-uppercase">Creador</label><select id="swal_us" class="form-select fw-bold">${usOptions}</select></div>
                </div>
            `,
            ...
            if (result.isConfirmed) {
                ...
                document.getElementById('formFiltrosSorteos').submit();
            } else if (result.dismiss === Swal.DismissReason.cancel) { window.location.href = 'sorteos.php'; }
        });
    }
    </script>
