...
<div class="container mt-n4 pb-5" style="position: relative; z-index: 20;">
    ...
    <div class="minimal-toolbar">
        <form id="formFiltrosDevoluciones" method="GET" class="d-flex w-100 align-items-center gap-2 m-0">
            ...
            <button type="button" class="btn btn-light border btn-filter-trigger shadow-sm" onclick="abrirFiltrosDevoluciones()">
    ...
    <script>
    function abrirFiltrosDevoluciones() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                document.getElementById('formFiltrosDevoluciones').submit();
            } else if (result.dismiss === Swal.DismissReason.cancel) { window.location.href = 'devoluciones.php'; }
        });
    }
    </script>
