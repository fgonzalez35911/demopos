...
<div class="container mt-n4 pb-5" style="position: relative; z-index: 20;">
    ...
    <div class="minimal-toolbar">
        <form id="formFiltrosVentas" method="GET" class="d-flex w-100 align-items-center gap-2 m-0">
            <div class="search-input-group">
                <i class="bi bi-search"></i>
                <input type="text" name="buscar" placeholder="Buscar N° Ticket o Cliente..." value="<?php echo htmlspecialchars($buscar); ?>" autocomplete="off">
            </div>
            ...
            <button type="button" class="btn btn-light border btn-filter-trigger shadow-sm" onclick="abrirFiltrosVentas()">
    ...
    <script>
    function abrirFiltrosVentas() {
        let usOptions = `<option value="">Todos los vendedores</option>`;
        ...
        Swal.fire({
            ...
            html: `
                <div style="text-align: left; display: flex; flex-direction: column; gap: 15px; margin-top: 10px;">
                    ...
                    <div><label class="small fw-bold text-muted text-uppercase">Cliente</label><select id="swal_cli" class="form-select fw-bold">${cliOptions}</select></div>
                </div>
            `,
            ...
            if (result.isConfirmed) {
                ...
                document.getElementById('formFiltrosVentas').submit();
            } else if (result.dismiss === Swal.DismissReason.cancel) { window.location.href = 'historial_ventas.php'; }
        });
    }
    </script>
