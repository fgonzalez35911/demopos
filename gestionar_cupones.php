...
<body class="bg-light">
    ...
    <div class="container-fluid mt-n4 pb-5 px-2 px-md-4" style="position: relative; z-index: 20;">
        ...
        <div class="minimal-toolbar">
            <form id="formFiltrosCupones" method="GET" class="d-flex w-100 align-items-center gap-2 m-0">
                <div class="search-input-group">
                    <i class="bi bi-search"></i>
                    <input type="text" name="buscar" placeholder="Buscar código de cupón..." value="<?php echo htmlspecialchars($buscar); ?>" autocomplete="off">
                </div>
                ...
                <button type="button" class="btn btn-light border btn-filter-trigger shadow-sm" onclick="abrirFiltrosCupones()">
        ...
        function abrirFiltrosCupones() {
            ...
            Swal.fire({
                title: 'FILTRAR CUPONES',
                html: `
                    <div style="text-align: left; display: flex; flex-direction: column; gap: 15px; margin-top: 10px;">
                        <div><label class="small fw-bold text-muted text-uppercase">Vencimiento Desde</label><input type="date" id="swal_desde" class="form-control fw-bold" value="${document.getElementById('hiddenDesde').value}"></div>
                        <div><label class="small fw-bold text-muted text-uppercase">Vencimiento Hasta</label><input type="date" id="swal_hasta" class="form-control fw-bold" value="${document.getElementById('hiddenHasta').value}"></div>
                ...
                if (result.isConfirmed) {
                    ...
                    document.getElementById('formFiltrosCupones').submit();
                } else if (result.dismiss === Swal.DismissReason.cancel) { window.location.href = 'gestionar_cupones.php'; }
            });
        }
        </script>
